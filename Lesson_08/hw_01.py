Не совсем так!
У вас все объекты будут создаваться с предустановленными дынными:
    brand = "Fiat Chrysler Automobiles"
    age = 2005
    color = "Black"
    mark = "Chrysler"
    weight = 2225
Надо использовать конструктор класса __init__ особым образом, чтобы выполнить задание: Атрибуты brand, age и mark являются обязательными при объявлении объекта.
В остальном всё ок
